...
namespace CapitalInsurance.Controllers
{
    public class Policy_EndorsementController : BaseController
    {
        ...
        public ActionResult PendingPolicyList(DateTime? FromDate, DateTime? ToDate, string PolicyNo = "", string Client = "", string SalesManager = "")
        {
            ...
            return PartialView("_PendingPolicyListGrid", new PolicyEndorsementRepository().GetNewPolicyForEndorse(UserID,UserRolename, FromDate, ToDate, PolicyNo, Client, SalesManager));
        }
        void FillDropdowns()
        {
            FillCustomer();
